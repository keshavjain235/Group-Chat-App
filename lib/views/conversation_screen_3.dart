...
class ConversationScreen3 extends StatefulWidget {
  @override
  _ConversationScreen3State createState() => _ConversationScreen3State();
}

class _ConversationScreen3State extends State<ConversationScreen3> {
  TextEditingController textEditingController = new TextEditingController();

  addMessagetoDb() async {
    await FirebaseFirestore.instance
        .collection("groupchat")
        .doc("iqCNahbTbRV7XagbIRv1")
        .collection("chats")
        .add({
